...
export const HomePage = () => {
  return (
    <div className="w-screen font-gilroy h-screen bg-[#F9EBFA] flex items-center flex-col">
      <div className="w-full h-full max-h-[186px] py-[84px] px-40 flex items-center justify-between">
        ...
        <Button className="bg-[#DD86DF] text-[#1F1B20] hover:bg-[#DD86DF] hover:shadow-xl">
          Call Jessica
        </Button>
      </div>
    </div>
